...
class TitanicTransformer(kserve.Model):
    ...
    def __init__(self, name: str,
        ...
        self.feature_refs_key = feature_refs #[feature_refs[i].replace(":", "__") for i in range(len(feature_refs))]
    ...
    def preprocess(self, inputs: Union[Dict, CloudEvent, InferRequest],
        ...
        params = {'feature_service': self.feature_refs, 'entities': self.buildEntityRow(inputs),
